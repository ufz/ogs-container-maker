...
class Cli_Args(argparse.ArgumentParser):
    def __init__(self, **kwargs):
        ...
        self.add_argument("--out", type=str, default="_out", help="Output directory")
        self.add_argument(
        ...
        switches_g.add_argument(
            "--gcovr", dest="gcovr", action="store_true", help="Install gcovr"
        )
        switches_g.add_argument(
            "--tfel", dest="tfel", action="store_true", help="Install tfel"
        )
        switches_g.add_argument(
            "--mpi_benchmarks",
            dest="mpi_benchmarks",
